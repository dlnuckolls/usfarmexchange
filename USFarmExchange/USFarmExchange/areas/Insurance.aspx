<%@ Page Title="" Language="C#" MasterPageFile="~/MasterContentPage.Master" AutoEventWireup="true" CodeBehind="Insurance.aspx.cs" Inherits="USFarmExchange.areas.Insurance" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent1" runat="server">
    <div class="justify">
        <asp:Literal ID="InsuranceHomeContent" runat="server"></asp:Literal>
        <br />
        <br />
    </div>
</asp:Content>
