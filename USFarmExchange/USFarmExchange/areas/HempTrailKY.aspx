...
<%-- 
  ...
  <div class="HempTrailKY">
    ...
    <img src="/images/HempTrailPage1.jpg" usemap="#image-map" width="100%" />

    <map name="image-map">
      <area target="_blank" alt="Test" title="Test" href="#" coords="484,480,100" shape="circle" />
      <area target="_blank" alt="test 2" title="test 2" href="#" coords="766,488,100" shape="circle" />
    </map>
  </div>
  --%>
