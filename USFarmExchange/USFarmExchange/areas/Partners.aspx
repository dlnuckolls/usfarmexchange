<%@ Page Title="" Language="C#" MasterPageFile="~/MasterContentPage.Master" AutoEventWireup="true" CodeBehind="Partners.aspx.cs" Inherits="USFarmExchange.areas.Partners" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent1" runat="server">
    <asp:Literal ID="PartnersHomeContent" runat="server"></asp:Literal>
    <br />
    <br />
</asp:Content>
