<%@ Page Title="" Language="C#" MasterPageFile="~/MasterContentPage.Master" AutoEventWireup="true" CodeBehind="News.aspx.cs" Inherits="USFarmExchange.areas.News" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent1" runat="server">
  <telerik:RadPageLayout runat="server" ID="MasterLayout" GridType="Fluid">
    <Rows>
      <telerik:LayoutRow>
        <Columns>
          <telerik:LayoutColumn Span="6" SpanSm="12">
            <div class="article">
          ...
          <telerik:LayoutColumn Span="6" SpanSm="12">
            <div class="article">
              <h2>Farming is the world’s most important career — that’s why it needs a new image</h2>
              <h5>August 26, 2019,  Karn Manhas</h5>
              <p>
                Editor’s Note: Karn Manhas is founder and CEO of Terramera, an agbiotech startup focused on improving the sustainability of farming. Here he writes about the importance of promoting the farming industry as an appealing and impactful career for the next generation.
              </p>
              <p>
              ...
              <p>
                We’ve heard time and again that millennials want meaningful careers that help make the world a better place. Often that interest is funnelled towards jobs in CleanTech, non-profits, the environment or the arts. But farming is an overlooked industry with incredible potential to help improve the world. 
              </p>
              <p>
